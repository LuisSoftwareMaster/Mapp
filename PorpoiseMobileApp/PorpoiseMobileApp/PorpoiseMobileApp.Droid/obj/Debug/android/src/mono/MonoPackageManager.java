...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "PorpoiseMobileApp.Droid.dll" comes first in this list. */
		"PorpoiseMobileApp.Droid.dll",
		"Acr.Settings.dll",
		...
		"MvvmCross.Plugins.Permissions.dll",
		"PorpoiseMobileApp.dll",
